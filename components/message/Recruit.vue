...
<div class="recruit">
  <div class="mui-input-row">
      ...
      <div class="mui-input-row">
          <label>招聘职位:</label>
          <input type="text" class="mui-input-clear" placeholder="请输入要招聘的职位" v-model="job">
        </div>
      <div class="mui-input-row">
          <label>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:</label>
...
import Upload from '@/components/top/Upload.vue'
  ...
  methods:{
    go9(){
      ...
      if(this.job .replace(/\s+/g,"").length==''){
        this.$toast({
          message:"招聘职位不能为空",
          position:3000
        });
