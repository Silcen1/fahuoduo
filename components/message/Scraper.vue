...
<div class="all">
 ...
 <div class="scraper">
    ...
    <div class="mui-input-row">
          <label>联系电话:</label>
          <input type="text" class="mui-input-clear" placeholder="请输入联系电话" v-model="tel">
        </div>
    <div class="mui-input-row">
          <label>手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机:</label>
