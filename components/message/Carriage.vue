...
<form action="">
 <div class="all">   
    ...
    <div class="made">
      ...
      <div class="mui-input-row">
          <label>联&nbsp;&nbsp;&nbsp;系&nbsp;&nbsp;&nbsp;人:</label>
          <input type="text" class="mui-input-clear" placeholder="请输入联系人姓名" v-model="name">
        </div>
      <div class="mui-input-row">
          <label>手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机:</label>
          <input type="text" class="mui-input-clear" placeholder="请输入联系电话" v-model="phone">
        </div>
      <div class="mui-input-row">
          <label>车&nbsp;厢&nbsp;类&nbsp;型:</label>
          <input type="text" class="mui-input-clear" placeholder="请输入车厢类型" v-model="coach">
        </div>
      <div class="mui-input-row">
          <label>地&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;址:</label>
